            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">sohan.soorya.k@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">+91 9538006513</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Bengaluru, KA</p>
                </div>
              </div>
            </div>
